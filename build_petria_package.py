...
make_alias(
    ...
    '-- Replica el #LOOP 1,2 del original: hasta 2 intentos, corta si detecta\n'
    '-- exito ("se desvanece." u "Ok.") en la respuesta del server.\n'
    ...
    '  local id\n'
    '  id = tempRegexTrigger("se desvanece\\\\.|Ok\\\\.", function()\n'
    '    killTrigger(id)\n'
    '    exito = true\n'
    ...
    '    if not exito then\n'
    '      if exists(id, "trigger") == 1 then killTrigger(id) end\n'
    '      if intentos < 2 then\n'
    '        intentar()\n'
    '      else\n'
    '        cecho("<red>Cancelacion fallida tras 2 intentos.\\n")\n'
    '      end\n'
    '    end\n'
    '  end)\n'
    'end\n\n'
...
make_alias(
    ...
    '-- Instala desde GitHub (raw), no un archivo local: asi funciona igual\n'
    '-- en cualquier PC, no solo en la que genero el archivo.\n'
    'cecho("<yellow>[Petria-Rhuna] Reinstalando...\\n")\n'
    'uninstallPackage("Petria-Rhuna")\n'
    'tempTimer(0.5, function()\n'
    '  installPackage("https://raw.githubusercontent.com/z0y1b0t/petria-mudlet/main/Petria-Rhuna.xml")\n'
