...
make_alias(
    ...
    '-- Confirmado en juego: installPackage() desde una URL puede fallar en\n'
    '-- silencio (sin "[INFO] Downloading"/"[OK] installed", ej. por un\n'
    '-- hiccup de red o el mirror de jsdelivr todavia sin sincronizar el\n'
    '-- ultimo commit) -- y como antes cecho-eabamos "Reinstalado." sin\n'
    '-- chequear nada, quedaba el paquete DESINSTALADO (uninstallPackage ya\n'
    '-- habia corrido) pero el usuario creia que habia funcionado. Ahora se\n'
    '-- verifica de verdad con getPackages() antes de avisar exito.\n'
    ...
    '      if nombre == "Petria-Rhuna" then instalado = true end\n'
    '    end\n'
    '    if instalado then\n'
    '      cecho("<green>[Petria-Rhuna] Reinstalado.\\n")\n'
    '    else\n'
    '      cecho("<red>[Petria-Rhuna] FALLO el reinstall (no aparece en getPackages()). Reintenta updatepkg en unos segundos, o instalalo manual con installPackage.\\n")\n'
    '    end\n'
    '  end)\n'
    'end)'
)
